...
#KDAS CFG (Ours)
CFG.KDAS = CN()
CFG.KDAS.START_RATE = 0.6
CFG.KDAS.END_RATE = 0.4
CFG.KDAS.SAMPLING_PERIOD = [1,3,5,10] #[1,2,3,4]
CFG.KDAS.EXCLUSION_RATE = 0.05 #0
CFG.KDAS.PENALTY_FACTOR = 0.5
CFG.KDAS.PENALTY_LAMBDA = 1000
CFG.KDAS.PENALTY_WARMUP = 0
CFG.KDAS.WARMUP_EPOCHS = 0 
CFG.KDAS.THRESHOLD = 0.2 #0.1
